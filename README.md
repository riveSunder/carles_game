...
* <strong>Update 2021/07/25:</strong> To allow for as many people as possible to participate, any submissions made before the IEEE Conference on Games competition session on 2021 August 20th will be considered a valid entry for the 2021 IEEE CoG competition track. That means I'll do my best to mention thoses enties in the contest session and to send the first 10 participants submitting before the contest session a free t-shirt, so long as they provide an address that threadless ships to. 
